...
<body style="background-color:black;">
  ...
  <h2> <span class="badge text-bg-secondary">Alteração de cadastro de clientes</span></h2>
  <br>
    ...
    <form action="#">
      ...
      <div class="row col-12 mt-2">
        <div class="col-md-7">
          ...
          <div class="input-group">
            <input type="text" class="form-control" id="cpf" placeholder="Digite o CPF" name="cpf" aria-label="CPF">
