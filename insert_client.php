...
<html lang="en" data-bs-theme="dark">
  ...
  <body style= "background-color:black";>
    ...
    <h2> <span class="badge text-bg-secondary";>Cadastro de clientes</span></h2>
    <br>
    <div class="form-check">
      ...
      <div class="form-check">
        <input class="form-check-input" type="radio" name="clientRadio" id="pessoaJuridicaRadio" checked onclick="pessoaJuridicaRadio()">
